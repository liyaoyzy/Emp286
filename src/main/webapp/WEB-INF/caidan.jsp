...
<head>
    ...
    <title>jQuery圆形图标菜单旋转切换代码 - 站长素材</title>

    <link rel="stylesheet" type="text/css" href="${BASE}/static/css/caidancss/normalize.css" /><!--CSS RESET-->
    <link rel="stylesheet" type="text/css" href="${BASE}/static/css/caidancss/demo.css"><!--演示页面样式，使用时可以不引用-->

    <link href="http://cdn.bootcss.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link rel="stylesheet" href="${BASE}/static/css/caidancss/circle.css">
...
<script src="${BASE}/static/jquery/caidanjs/jquery-1.11.0.min.js" type="text/javascript"></script>
<script src="${BASE}/static/jquery/caidanjs/circle.js"></script>
